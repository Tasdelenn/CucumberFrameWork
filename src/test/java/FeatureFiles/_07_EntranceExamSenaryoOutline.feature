...
Feature: Entrance Exam Functionality
  ...
  Scenario Outline: Create and Delete a Exam
    ...
    Examples:
      | ExamName       | AcademicPeriodOption | GradeLevelOption |
      | Math exam h1   | academicPeriod1      | gradeLevel2      |
      | IT exam h1     | academicPeriod1      | gradeLevel2      |
      | Oracle exam h1 | academicPeriod1      | gradeLevel2      |
      | Math exam2  h1 | academicPeriod1      | gradeLevel2      |
